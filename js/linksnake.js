...
(function(namespace){
  ...
  var ANIMATION_TIME = 60 // Retardo entre las iluminaciones en la animación de victoria
  ...
  function light_animation() {
    ...
    var cols = data_model.cols, rows = data_model.rows;
    
    var white_board = function() {
      context.fillStyle = "rgba(255, 255, 255, 0.5)";
      context.fillRect(margin_x, margin_y, cols * box_size, rows * box_size);
